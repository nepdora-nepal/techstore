                        ...
                        <div className="space-y-8 relative z-10">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+9779800000000" className="text-white font-medium hover:text-brand-300 transition-colors">+977-9800000000</a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:support@techstore.com" className="text-white font-medium hover:text-brand-300 transition-colors">support@techstore.com</a>
                                </div>
                            </div>
