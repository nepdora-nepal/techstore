        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-4 -mt-16 relative z-20">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        <div key={i} className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-gray-100 text-center">
            ...
            <div className="max-w-7xl mx-auto px-4 py-24">
                <div className="grid md:grid-cols-2 gap-20 items-center">
                    <div>
                        <h2 className="text-3xl md:text-5xl font-black text-navy-950 mb-8 leading-tight">Our mission is to empower human potential.</h2>
                        <div className="space-y-6 text-slate-500 font-medium leading-relaxed">
                            <p>We believe that technology should be an extension of self—intuitive, powerful, and aesthetically flawless. That&apos;s why every product in our collection undergoes rigorous vetting for quality and performance.</p>
                            <p>From the latest silicon breakthroughs to sustainable manufacturing, we stay at the forefront of the digital revolution so you don&apos;t have to.</p>
                        </div>
                        <div className="pt-10">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-white p-6 rounded-[2rem] shadow-2xl border border-gray-100 flex flex-col items-center justify-center text-center">
                            ...
                            <p className="text-[8px] font-black text-navy-950 uppercase tracking-widest">Tech Retailer 2024</p>
                        </div>
                    </div>
                </div>
            </div>
