                    ...
                    <div className="bg-navy-950 p-12 md:p-20 text-center relative overflow-hidden">
                        <div className="relative z-10">
                            ...
                            <p className="text-slate-400 max-w-xl mx-auto font-medium text-lg leading-relaxed">
                                Every device purchased through {siteConfig?.business_name || 'TechStore'} is protected by our industry-leading comprehensive protection plan.
                            </p>
                        </div>
                    ...
                    <div className="p-8 md:p-20">
                        <div className="grid md:grid-cols-3 gap-8">
                            {[
                                ...
                                { icon: Clock, title: "Priority Support", desc: "Elite program members get 24/7 direct access to lead hardware engineers." },
                            ].map((item, i) => (
                                ...
                                {faqs && faqs.length > 0 ? (
                                    faqs.slice(0, 4).map((faq) => (
                                        <div key={faq.id} className="space-y-4">
                                            <h4 className="font-bold text-navy-950">{faq.question}</h4>
                                            <p className="text-sm text-gray-500 font-medium">{faq.answer}</p>
                                        </div>
                                    ))
                                ) : (
                                    <>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <p className="text-sm text-gray-500 font-medium">All products are automatically registered to your profile upon delivery.</p>
                                        </div>
                                    </>
                                )}
                            </div>
