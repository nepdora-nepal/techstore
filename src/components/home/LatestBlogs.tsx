...
export const LatestBlogs: React.FC = () => {
    ...
    return (
        <section className="py-16 md:py-24 px-4 max-w-7xl mx-auto bg-white">
            <div className="mb-12">
                <span className="text-indigo-600 font-bold tracking-widest uppercase text-xs mb-2 block">Insights & News</span>
                    ...
                    blogs.slice(0, 3).map(blog => (
                        <article key={blog.id} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-slate-100">
                            ...
                            <div className="p-6 flex flex-col h-full">
                                ...
                                <Link href={`/news/${blog.slug}`} className="text-sm font-bold flex items-center gap-2 text-slate-900 group-hover:text-indigo-600 mt-auto">
