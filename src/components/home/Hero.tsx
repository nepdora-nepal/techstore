...
const Hero: React.FC = () => {
  ...
  const heroSlides = [
    ...
    },
    {
      id: 2,
      image:
        "https://images.unsplash.com/photo-1603302576837-37561b2e2302?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
    ...
    },
    {
      id: 3,
      image:
        "https://images.unsplash.com/photo-1579586337278-3befd40fd17a?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80",
  ...
  return (
    <div className="relative bg-navy-950 overflow-hidden h-[400px] md:h-[550px] lg:h-[650px]">
      <AnimatePresence mode="wait">
        ...
        >
          <ImageWithFallback
            id={`hero-slide-${heroSlides[heroIndex].id}`}
          ...
          <div
            className={`absolute inset-0 bg-gradient-to-r ${heroSlides[heroIndex].color} via-transparent to-transparent flex items-center`}
          >
