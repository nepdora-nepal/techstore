    ...
    return (
        <section className="py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className={`relative rounded-3xl overflow-hidden ${bgClass} text-white min-h-[360px] md:min-h-[420px] flex items-center shadow-2xl group`}>
                    ...
                    <div className={`relative z-10 w-full grid grid-cols-1 md:grid-cols-2 gap-8 items-center p-8 md:p-16 ${variant === 'right' ? '' : ''}`}>

                        {/* Text Content */}
                        <div className={`order-2 ${variant === 'right' ? 'md:order-1' : 'md:order-2'} ${variant === 'right' ? 'md:pr-12' : 'md:pl-12'}`}>
