            ...
            <div className="bg-navy-950 text-white rounded-3xl shadow-2xl p-4 flex items-center justify-between gap-6 border border-white/10 backdrop-blur-md">
                <div className="flex items-center gap-4 flex-1">
                    <div className="hidden md:flex flex-col">
                        <span className="text-xs font-black uppercase tracking-widest text-brand-400">Compare</span>
                        <span className="text-[10px] opacity-60 font-medium">({compareItems.length}/4 items)</span>
                    </div>
